...
init -501 screen main_menu():
    ...
    if persistent.ghost_menu:
    ...
    elif persistent.current_day == 3:
        add "menu_bg_evil"
        add "menu_art_s_evil"
        add "menu_art_n_evil"
        add "menu_art_shikuza_evil"
        add "menu_art_ayano_evil"
        add "menu_art_akira_evil"
        add "menu_art_sakura_evil"
        frame
        use navigation
    else:
        add "menu_bg"
        ...
        add "menu_art_akira"
        add "menu_art_sakura"
        add "menu_art_squidward"
        add "menu_art_baldi"
        add "menu_art_foxy"
        add "menu_art_freddy"
        add "menu_art_toyFreddy"
        add "menu_art_eddy"
        add "menu_art_helpy"
        add "menu_art_bg"
        frame
...
screen top_right_text():
    frame:
        align (0.98, 0.01)
        text "[playerMoney]kr" color "#FFFFFF" size 30

screen day_text():
    frame:
        align (0.98, 0.10)
        text "Dag: [currentDay]" color "#FFFFFF" size 30